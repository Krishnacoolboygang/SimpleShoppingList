...
public class List extends TableRow implements OnLongClickListener {
	...
	private void showRemoveListDialog() {
		...
		d.setTitle(((ManageLists) context).getText(R.string.dialog_remove_list_title));
		d.setMessage(((ManageLists) context).getText(R.string.dialog_remove_list_message));
